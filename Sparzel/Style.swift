...
struct ColorConstants {
    ...
    static var settingsShadows = UIColor(hexString: "#E0E4EA", alpha: 0.5)
    ...
    static func nightMode() {
        ...
        navShadow = UIColor(hexString: "#202225", alpha: 0.7)
        ...
        settingsShadows = UIColor(hexString: "#202225", alpha: 0.7)
    }
