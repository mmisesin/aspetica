...
struct ColorConstants {
    ...
    static var mainTextBlockedColor = UIColor(hexString: "#7D8D9D", alpha: 1)
    ...
    static func nightMode() {
        ...
        mainTextBlockedColor = UIColor(hexString: "#74767B", alpha: 1)
    ...
    static func defaultMode() {
        ...
        mainTextBlockedColor = UIColor(hexString: "#7D8D9D", alpha: 1)
